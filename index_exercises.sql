...
CREATE TABLE `albums2` (
                           ...
                           PRIMARY KEY (`id`),
                           UNIQUE KEY `artist_name_album_name` (`artist_name`,`album_name`)
) ENGINE=InnoDB AUTO_INCREMENT=46 DEFAULT CHARSET=utf8mb4;

INSERT INTO `albums2` (artist_name, album_name,release_date,sales,genre)
 VALUES
        ('Cody',	'After the Fire',	2018,	2.5,	'Americana, Country')
